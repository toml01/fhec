...
pub static CATALOG: &[CatalogEntry] = &[
    ...
    CatalogEntry { code: "FHE4002", severity: "warning", name: "view-return-without-acl", rule: "§8.4", summary: "View or pure function returns an encrypted value; ACL cannot be granted in view or pure context." },
